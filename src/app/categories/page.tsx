...
export default function CategoriesPage() {
  ...
  const PREDEFINED_COLORS = [
    ...
    { name: "Emerald", bg: "bg-emerald-500", text: "text-emerald-600 dark:text-emerald-400 bg-emerald-50 dark:bg-emerald-500/10" },
    { name: "Green", bg: "bg-green-500", text: "text-green-600 dark:text-green-400 bg-green-50 dark:bg-green-500/10" },
    { name: "Teal", bg: "bg-teal-500", text: "text-teal-600 dark:text-teal-400 bg-teal-50 dark:bg-teal-500/10" },
    { name: "Cyan", bg: "bg-cyan-500", text: "text-cyan-600 dark:text-cyan-400 bg-cyan-50 dark:bg-cyan-500/10" },
    { name: "Sky", bg: "bg-sky-500", text: "text-sky-600 dark:text-sky-400 bg-sky-50 dark:bg-sky-500/10" },
    { name: "Indigo", bg: "bg-indigo-500", text: "text-indigo-600 dark:text-indigo-400 bg-indigo-50 dark:bg-indigo-500/10" },
    { name: "Violet", bg: "bg-violet-500", text: "text-violet-600 dark:text-violet-400 bg-violet-50 dark:bg-violet-500/10" },
    { name: "Purple", bg: "bg-purple-500", text: "text-purple-600 dark:text-purple-400 bg-purple-50 dark:bg-purple-500/10" },
    { name: "Fuchsia", bg: "bg-fuchsia-500", text: "text-fuchsia-600 dark:text-fuchsia-400 bg-fuchsia-50 dark:bg-fuchsia-500/10" },
    { name: "Pink", bg: "bg-pink-500", text: "text-pink-600 dark:text-pink-400 bg-pink-50 dark:bg-pink-500/10" },
    { name: "Rose", bg: "bg-rose-500", text: "text-rose-600 dark:text-rose-400 bg-rose-50 dark:bg-rose-500/10" },
    { name: "Red", bg: "bg-red-500", text: "text-red-600 dark:text-red-400 bg-red-50 dark:bg-red-500/10" },
    { name: "Orange", bg: "bg-orange-500", text: "text-orange-600 dark:text-orange-400 bg-orange-50 dark:bg-orange-500/10" },
    { name: "Amber", bg: "bg-amber-500", text: "text-amber-600 dark:text-amber-400 bg-amber-50 dark:bg-amber-500/10" },
    { name: "Yellow", bg: "bg-yellow-500", text: "text-yellow-600 dark:text-yellow-400 bg-yellow-50 dark:bg-yellow-500/10" },
    { name: "Lime", bg: "bg-lime-500", text: "text-lime-600 dark:text-lime-400 bg-lime-50 dark:bg-lime-500/10" },
    { name: "Slate", bg: "bg-slate-500", text: "text-slate-600 dark:text-slate-400 bg-slate-50 dark:bg-slate-500/10" },
  ];
